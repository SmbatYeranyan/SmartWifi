...
void SmartWifi::createWebServer(int webtype){
  ...
  if ( webtype == 1 ) {
    server.on("/", []() {
        ...
        //content += "<p>";
        //content += st;
        content += "<!DOCTYPE html> <html > <head> <meta charset='UTF-8'> <title>"+uiTitle+" Setup</title> <meta name='viewport' content='width=device-width, initial-scale=1.0'>";
